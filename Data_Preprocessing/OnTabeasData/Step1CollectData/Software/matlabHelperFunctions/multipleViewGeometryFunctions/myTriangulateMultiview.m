...
%
%   cameraParams  a N-element cell-array of cameraParameters objects
%
%   Output:
%   -------
...
function [points3d, errors] = myTriangulateMultiview(pointTracks, ...
    camPoses, cameraParams)

outputType = validateInputs(pointTracks, camPoses, cameraParams{1});
...
for i = 1:numCameras
    ...
    cameraMatrices(id) = cameraMatrix(cameraParams{i}, R', -t*R');
end
