        ...
        for i in range(nr_of_epochs):
            ...
            if(i%nr_of_epochs_until_save_model ==0):
                ...
                if(match_probability > training_matches):
                    training_matches+=3
                    mailer.mailto("Number of Matches in the training Set reached "+str(match_probability)+" %. Done in "+ str(i)+ " Steps")
                ...
                if(match_probability > validation_matches):
                    ...
                    mailer.mailto("Number of Matches in the validation Set reached "+str(match_probability)+" %. Done in "+ str(i)+ " Steps")
                sess.run(training_init_op)

                saver.save(sess=sess, save_path=origin_path + "../../getfingers_heinz/weights_higher_learnrate/pretrain_model.ckpt", global_step=i)
                print("model updatet\n")
