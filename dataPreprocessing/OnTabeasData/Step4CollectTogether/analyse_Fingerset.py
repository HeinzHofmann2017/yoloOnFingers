...
#         if not os.path.exists(origin_path+"trainDataset"):
#             os.makedirs(origin_path + "trainDataset")
#         if not os.path.exists(origin_path+"validDataset"):
#             os.makedirs(origin_path + "validDataset")
# 
#         for dataSet in ["valid","train"]:
#             if(dataSet == "train"):
#                 save_path = origin_path + "/trainDataset/"
#             elif(dataSet == "valid"):
#                 save_path = origin_path + "/validDataset/"
#                     
#             #get number of Pictures
#             nrOfElements = 0
#             for camera_nr in range(nrOfCams):
#                 with open(origin_path + "/Camera_"+str(camera_nr)+"/UV_Bin/"+dataSet+"Data.csv") as csvfile_read:
#                     reader = csv.DictReader(csvfile_read,fieldnames=["picName","x_coord","y_coord","bb_diameter","P"])
#                     for row in reader:
#                         nrOfElements+=1
#                         
...
#                                 # height
#                                 label_tensor[global_index,y_box_and_offset,x_box_and_offset,2]=3*float(row["bb_diameter"])/960
#                                 # width
#                                 label_tensor[global_index,y_box_and_offset,x_box_and_offset,3]=3*float(row["bb_diameter"])/1280
...
#     
#     
#                         cv2.imwrite(save_path+global_picName,img)            
#                         global_index += 1
#                         
#     
...
#==============================================================================
    ...
    def get_train_data(self, origin_path = "/media/hhofmann/dgx/data_hhofmann/Data/indexfinger_right/9000/"):
        ...
        2.Dim:  0 = Picture-Name
                ...
                3 = height of the Boundingbox
                4 = width of the Boundingbox
                5 = probability that there is a Indexfinger in the picture.                
        '''
    ...
    def get_valid_data(self, origin_path = "/media/hhofmann/dgx/data_hhofmann/Data/indexfinger_right/9000/"):
        ...
        2.Dim:  0 = Picture-Name
                ...
                5 = probability that there is a Indexfinger in the picture.                
        '''
        return pickle.load(open(origin_path + "validDataset/data.pkl","rb"))
